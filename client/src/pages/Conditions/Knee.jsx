...
const CONDITIONS = [
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREs1q3h__sau7PP72QlsN_5qs4YwHs4QcL_Z-bLDKP4w&s=10",
    title: "Knee Pain",
    description:
      "Persistent or recurring knee pain that can affect walking, exercise and everyday movement.",
  },
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTT2kRRCewgUF2vMH726hIkjUCa3hMnWSpB3oSISvOVcQ&s=10",
    title: "Knee Injuries",
    description:
      "Assessment and treatment for common knee injuries affecting movement, stability and function.",
  },
  {
    image:
      "https://images.pexels.com/photos/35054137/pexels-photo-35054137.jpeg?auto=compress&cs=tinysrgb&w=1000",
    title: "Knee Joint Problems",
    description:
      "Evaluation of conditions affecting the bones, cartilage and structures within the knee.",
  },
  {
    image:
      "https://images.pexels.com/photos/7339493/pexels-photo-7339493.jpeg?auto=compress&cs=tinysrgb&w=1000",
    title: "Ligament Injuries",
    description:
      "Specialized care for ligament injuries that can cause pain, instability and reduced mobility.",
  },
  {
    image:
      "https://images.pexels.com/photos/27376661/pexels-photo-27376661.jpeg?auto=compress&cs=tinysrgb&w=1000",
    title: "Knee Arthritis",
    description:
      "Care focused on knee joint changes that may cause pain, stiffness and difficulty moving.",
  },
  {
    image:
      "https://images.pexels.com/photos/29558666/pexels-photo-29558666.jpeg?auto=compress&cs=tinysrgb&w=1000",
    title: "Sports Knee Injuries",
    description:
      "Treatment and recovery support for knee injuries associated with sports and active lifestyles.",
  },
];
...
const FEATURES = [
  {
    ...
    text:
      "Understanding your symptoms, activity level, medical history and movement.",
    icon: "clipboard",
  },
  {
    number: "02",
    ...
    text:
      "Clinical assessment and appropriate imaging to understand the knee problem.",
    icon: "scan",
  },
  {
    number: "03",
    ...
    text:
      "A care plan built around your condition, lifestyle and movement goals.",
    icon: "person",
  },
  {
    number: "04",
    ...
    text:
      "Focused care supporting strength, mobility and comfortable everyday movement.",
    icon: "shield",
  },
];
...
const APPROACH = [
  {
    ...
    title: "Assessment",
    text:
      "Detailed evaluation of symptoms, activity level and knee movement.",
    icon: "clipboard",
  },
  {
    number: "02",
    title: "Diagnosis",
    text:
      "Identifying the underlying cause using appropriate clinical assessment.",
    icon: "search",
  },
  {
    number: "03",
    title: "Treatment",
    text:
      "A personalized treatment plan based on your knee condition and goals.",
    icon: "care",
  },
  {
    number: "04",
    title: "Recovery",
    text:
      "Guided rehabilitation focused on restoring strength and movement.",
    icon: "body",
  },
];
  ...
  if (type === "care") {
    return (
      ...
      >
        ...
        <path d="M8 10c-2 .5-3.5 2-4 4M16 10c2 .5 3.5 2 4 4" />
      </svg>
    );
  }
    ...
    <main className="bg-white text-[#173F3D]">
      ...
      <section className="relative min-h-[730px] overflow-visible bg-[#0B3A37] pt-[88px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvfAFBnOPG1ZDp1SJzS-HzFkL2TPONaQq--Bf3kex3Fg&s=10"
          ...
          <div className="w-full">
            ...
            <div className="max-w-[570px]">
              ...
              <p className="mt-8 max-w-[500px] text-[15px] leading-7 text-white/75 md:text-base md:leading-8">
                Specialized assessment and treatment for knee pain,
                sports injuries, ligament problems and conditions
                affecting comfortable movement.
              </p>
          ...
          <div className="grid md:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Focused care for the bones, cartilage and structures of the knee.
                </p>
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Understanding ligament, cartilage and movement-related problems.
                </p>
            ...
            <div className="flex gap-4 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Supporting strength, mobility and confident everyday movement.
                </p>
        ...
        <div className="mx-auto grid max-w-[1300px] gap-16 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div>
            ...
            <p className="mt-7 max-w-[480px] text-sm leading-7 text-gray-600 md:text-[15px]">
              Knee pain can affect walking, exercise, work and
      ...
      <section className="bg-white px-6 py-24 text-center md:py-32">
        ...
        <p className="mx-auto mt-7 max-w-[530px] text-sm leading-7 text-gray-500">
          If knee pain is affecting your everyday life,
