...
const CONDITIONS = [
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFTcPplyn0mgUsgi01QciDKLVABh-S74wZIzKROMe6fw&s=10",
    title: "Hip Pain",
    description:
      "Persistent or recurring hip pain that can affect walking, exercise, sleep and everyday activities.",
  },
  {
    image:
  ...
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpRs830eS5I3XIW31oY-lUYmoOuaKzYktQsPyrrFMYsw&s=10",
    title: "Hip Stiffness",
    description:
      "Focused care for restricted hip movement, stiffness and discomfort during daily activities.",
  },
  {
    image:
...
const FEATURES = [
  {
    ...
    text:
      "Understanding your symptoms, walking pattern, hip movement and medical history.",
    icon: "clipboard",
  },
  {
    number: "02",
    ...
    text:
      "Clinical assessment and appropriate imaging to understand the underlying hip condition.",
    icon: "scan",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    text:
      "Focused care supporting strength, stability, mobility and comfortable movement.",
    icon: "shield",
  },
];
...
const APPROACH = [
  {
    ...
    title: "Assessment",
    text:
      "Detailed evaluation of symptoms, hip movement, strength and functional limitations.",
    icon: "clipboard",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    title: "Treatment",
    text:
      "A personalized treatment plan based on your hip condition and recovery goals.",
    icon: "care",
  },
  {
    number: "04",
    title: "Recovery",
    text:
      "Guided rehabilitation focused on restoring strength, stability and movement.",
    icon: "body",
  },
];
    ...
    <main className="bg-white text-[#173F3D]">
      ...
      <section className="relative min-h-[730px] overflow-visible bg-[#0B3A37] pt-[88px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDpJUuxqW66kSCa8s59-abDpVQH-cn0jIhMKHs7nr0wQ&s=10"
            alt="Hip orthopedic care"
            className="
              absolute
              right-0
              top-0
          ...
          <div className="w-full">
            ...
            <div className="max-w-[570px]">
              ...
              <p className="mt-8 max-w-[500px] text-[15px] leading-7 text-white/75 md:text-base md:leading-8">
                Specialized assessment and treatment for hip pain,
                arthritis, injuries, stiffness and conditions affecting
          ...
          <div className="grid md:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Focused care for the hip joint, muscles and surrounding structures.
                </p>
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Understanding joint changes, injuries and movement-related hip problems.
                </p>
            ...
            <div className="flex gap-4 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Supporting strength, balance, mobility and confident everyday movement.
                </p>
        ...
        <div className="mx-auto grid max-w-[1300px] gap-16 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div>
            ...
            <p className="mt-7 max-w-[480px] text-sm leading-7 text-gray-600 md:text-[15px]">
              Hip pain can affect walking, sleep, exercise and
      ...
      <section className="bg-white px-6 py-24 text-center md:py-32">
        ...
        <p className="mx-auto mt-7 max-w-[530px] text-sm leading-7 text-gray-500">
          If hip pain is affecting your everyday life, a
