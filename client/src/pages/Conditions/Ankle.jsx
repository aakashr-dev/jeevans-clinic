...
const CONDITIONS = [
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQffPA9GXklk7oqFlaZxLzke3VGS07qUJb_7zt5OPKCmw&s=10",
    title: "Ankle Pain",
    description:
      "Persistent or recurring ankle pain that can affect walking, exercise, balance and everyday movement.",
  },
  {
    image:
...
const FEATURES = [
  {
    ...
    text:
      "Understanding your symptoms, walking pattern, ankle movement and medical history.",
    icon: "clipboard",
  },
  {
    number: "02",
    ...
    text:
      "Clinical assessment and appropriate imaging to understand the underlying ankle problem.",
    icon: "scan",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    text:
      "Focused care supporting strength, stability, balance and comfortable everyday movement.",
    icon: "shield",
  },
];
...
const APPROACH = [
  {
    ...
    title: "Assessment",
    text:
      "Detailed evaluation of symptoms, ankle movement, strength, balance and stability.",
    icon: "clipboard",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    title: "Treatment",
    text:
      "A personalized treatment plan based on your ankle condition and recovery goals.",
    icon: "care",
  },
  {
    number: "04",
    title: "Recovery",
    text:
      "Guided rehabilitation focused on restoring strength, stability and confident movement.",
    icon: "body",
  },
];
    ...
    <main className="bg-white text-[#173F3D]">
      ...
      <section className="relative min-h-[730px] overflow-visible bg-[#0B3A37] pt-[88px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXeDyCgOq2a-VlsCPRdkd7j6vaUHndCUhI_iJxTnfDug&s=10"
            alt="Ankle orthopedic care"
            className="
              absolute
              right-0
              top-0
          ...
          <div className="w-full">
            ...
            <div className="max-w-[570px]">
              ...
              <p className="mt-8 max-w-[500px] text-[15px] leading-7 text-white/75 md:text-base md:leading-8">
                Specialized assessment and treatment for ankle pain,
                sprains, ligament injuries, instability and conditions
                affecting comfortable walking and movement.
              </p>
          ...
          <div className="grid md:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Focused care for the ankle joint, ligaments and surrounding structures.
                </p>
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Understanding sprains, ligament injuries and movement-related ankle problems.
                </p>
            ...
            <div className="flex gap-4 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Supporting strength, balance, stability and confident everyday movement.
                </p>
        ...
        <div className="mx-auto grid max-w-[1300px] gap-16 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div>
            ...
            <p className="mt-7 max-w-[480px] text-sm leading-7 text-gray-600 md:text-[15px]">
              Ankle pain can affect walking, balance, exercise and
      ...
      <section className="bg-white px-6 py-24 text-center md:py-32">
        ...
        <p className="mx-auto mt-7 max-w-[530px] text-sm leading-7 text-gray-500">
          If ankle pain is affecting your everyday life,
