...
const CONDITIONS = [
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYs1OkgIvRb1OWJaF7IfZi_aNtGXcd13ZmzG_pEjkguA&s=10",
    title: "Back Pain",
    description:
      "Persistent or recurring back pain that can affect work, sleep, exercise and everyday movement.",
  },
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaqtBRKBfOziyfkpEKifOs2fr80WG7JZET6sVSkaaKWw&s=10",
    title: "Disc Problems",
    description:
      "Care for spinal disc conditions that may cause pain, stiffness, weakness or discomfort.",
  },
  {
    image:
...
const FEATURES = [
  {
    ...
    text:
      "Understanding your symptoms, posture, movement patterns and medical history.",
    icon: "clipboard",
  },
  {
    number: "02",
    ...
    text:
      "Clinical assessment and appropriate imaging to understand the underlying spinal problem.",
    icon: "scan",
  },
  {
    number: "03",
...
const APPROACH = [
  {
    ...
    title: "Assessment",
    text:
      "Detailed evaluation of symptoms, posture, movement and spinal function.",
    icon: "clipboard",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    title: "Treatment",
    text:
      "A personalized treatment plan based on your spinal condition and recovery goals.",
    icon: "care",
  },
  {
    number: "04",
    title: "Recovery",
    text:
      "Guided rehabilitation focused on restoring strength, mobility and confidence.",
    icon: "body",
  },
];
    ...
    <main className="bg-white text-[#173F3D]">
      ...
      <section className="relative min-h-[730px] overflow-visible bg-[#0B3A37] pt-[88px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRjKQwvqa3SH8bwR55jZk3lj1GEQFvWHPUQITJKwSDGw&s=10"
            alt="Spine care and orthopedic treatment"
            className="
              absolute
              right-0
              top-0
          ...
          <div className="w-full">
            ...
            <div className="max-w-[570px]">
              ...
              <p className="mt-8 max-w-[500px] text-[15px] leading-7 text-white/75 md:text-base md:leading-8">
                Specialized assessment and treatment for back pain,
                disc problems, nerve compression and spinal conditions
          ...
          <div className="grid md:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Focused care for the spine, discs, joints and surrounding structures.
                </p>
            ...
            <div className="flex gap-4 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] leading-5 text-gray-500">
                  Supporting strength, flexibility and confident everyday movement.
                </p>
        ...
        <div className="mx-auto grid max-w-[1300px] gap-16 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div>
            ...
            <p className="mt-7 max-w-[480px] text-sm leading-7 text-gray-600 md:text-[15px]">
              Spine and back pain can affect work, sleep, exercise
              and everyday activities. Understanding the underlying
      ...
      <section className="bg-white px-6 py-24 text-center md:py-32">
        ...
        <p className="mx-auto mt-7 max-w-[530px] text-sm leading-7 text-gray-500">
          If spine or back pain is affecting your everyday life,
